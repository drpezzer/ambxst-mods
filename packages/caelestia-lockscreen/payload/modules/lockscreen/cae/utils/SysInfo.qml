...
Singleton {
    ...
    property string osLogo: Qt.resolvedUrl(`${Quickshell.shellDir}/modules/lockscreen/cae/assets/logo.svg`)
    ...
    FileView {
        ...
        onLoaded: {
            ...
            if (GlobalConfig.general.logo === "caelestia") {
                root.osLogo = Qt.resolvedUrl(`${Quickshell.shellDir}/modules/lockscreen/cae/assets/logo.svg`);
