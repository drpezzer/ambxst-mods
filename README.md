...
| [roadie](packages/roadie) | **Ambxst Roadie.** A clean boot (background colour, wallpaper and frame, the Ambxst lock unless you came through a greeter, then the bar), a staged leave and enter around every reload, a shutdown / reboot farewell (the notch swells into the whole screen and a film or TV quote fades in; add your own in Settings > Mods), Dual Screen Single Bar, staged chrome around fullscreen windows, monitor hotplug without a reload. Replaces clean-load and multi-monitor-fixes |
