...
| [caelestia-lockscreen](packages/caelestia-lockscreen) | Caelestia's lockscreen ported: blurred desktop grab, padlock intro, Material-shapes password field, per-screen placement and lock-on-start |
